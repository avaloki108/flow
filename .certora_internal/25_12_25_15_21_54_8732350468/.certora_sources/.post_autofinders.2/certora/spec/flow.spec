methods {
    ...
    function balanceOf(address token, address owner) external returns (uint256) envfree;
    function allowance(address token, address owner, address spender) external returns (uint256) envfree;
}
